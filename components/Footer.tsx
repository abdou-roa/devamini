    ...
    return(
        <Container disableGutters  sx={{minWidth: '100vw', backgroundColor: '#fff',  boxSizing: 'border-box', marginTop: '64px', paddingTop: '40px'}}>
            <Container maxWidth="lg">
                <Grid container>
                        <Grid item xs={12} lg={4} sx={{ color: 'black', display: 'flex', justifyContent: 'center'}}>
                            <Box>
                                <Typography variant="h2">Devamini</Typography>
                                <Typography variant="body1" sx={{maxWidth:'400px', fontSize: '16px'}}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facilis iste facere sapiente eaque, ipsa ea.</Typography>
                            </Box>
                        </Grid>
                    <Grid item xs={12} lg={4} sx={{ color: 'black', display: 'flex', justifyContent: 'center'}}>
                        <Box>
